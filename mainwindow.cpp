...
void MainWindow::createDemoFiles(){
    ...
    Isys->createFile("photosss9.pdf", "sys", "data", "documents");
    Isys->deleteFile("photosss9.pdf");
    ...
    fSys->createFile("photosss9.pdf", "sys", "data", "documents");
    fSys->deleteFile("photosss9.pdf");
